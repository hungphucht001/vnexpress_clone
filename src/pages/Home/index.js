...
import { data_header, data_sidebar, data_content, data_bottom } from './data'
function Home() {
    ...
    return (
        <div className='wrapper-home'>
            ...
            <hr />
            <div className='row'>
                <div className='col-md-12 col-lg-4 pe-0 br-1'>
                    <div className='row'>
                        {
                            data_sidebar.map((item, index) => <PostItemTitile key={index} item={item} />)
                        }
                    </div>
                </div>
                <div className='col-md-12 col-lg-8 ps-3'>
                    <div className='row'>
                        {
                            data_content.map((item, index) => <BoxItem key={index} item={item} />)
                        }
                    </div>
                </div>
            </div>
            ...
            {
                data_bottom.map((item, index) => <BoxContainer key={index} item={item} />)
            }
        </div>
    )
}
